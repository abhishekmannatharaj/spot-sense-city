...
const mockParkingSpots: ParkingSpot[] = [
  ...
  },
  {
    ...
    description: 'Private garage spot perfect for city center visits, just 5 minutes walk to MG Road. Monthly subscription available.',
    ...
    availableFrom: '07:00',
    availableTo: '23:59',
    amenities: ['Gated', 'EV Charging', 'Monthly Subscription'],
    isActive: true,
    createdAt: new Date(),
  },
  {
  ...
  },
  {
    ...
    description: 'Secure basement parking in HSR Layout with monthly subscription option, close to restaurants and shopping centers.',
    ...
    availableFrom: '08:00',
    availableTo: '23:00',
    amenities: ['Security Cameras', 'Underground', 'Monthly Subscription'],
    isActive: true,
    createdAt: new Date(),
  }
];
